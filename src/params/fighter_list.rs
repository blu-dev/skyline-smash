...
lazy_static! {
    pub static ref FIGHTER_LIST_ORDER: HashMap<i32, usize> = {
        ...
        m.insert(*FIGHTER_KIND_EFLAME, 75);
        m.insert(*FIGHTER_KIND_ELIGHT, 76);
        m.insert(*FIGHTER_KIND_EDGE, 77);
        m.insert(*FIGHTER_KIND_MIIFIGHTER, 78);
        m.insert(*FIGHTER_KIND_MIISWORDSMAN, 79);
        m.insert(*FIGHTER_KIND_MIIGUNNER, 80);
        m.insert(*FIGHTER_KIND_SAMUSD, 81);
        m.insert(*FIGHTER_KIND_DAISY, 82);
        m.insert(*FIGHTER_KIND_LUCINA, 83);
        m.insert(*FIGHTER_KIND_CHROM, 84);
        m.insert(*FIGHTER_KIND_PITB, 85);
        m.insert(*FIGHTER_KIND_KEN, 86);
        m.insert(*FIGHTER_KIND_RICHTER, 87);
        m.insert(*FIGHTER_KIND_KOOPAG, 88);
        m.insert(*FIGHTER_KIND_MIIENEMYF, 89);
        m.insert(*FIGHTER_KIND_MIIENEMYS, 90);
        m.insert(*FIGHTER_KIND_MIIENEMYG, 91);
        m
    };
